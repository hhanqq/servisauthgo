...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // email for user in register
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // pass for user in register
}
...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // id for user
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // email of the user on login
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // pass of the user on login
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // id of the app to login (id app for any serves)
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // auth token of the logged in user // string because jwt open ( can see all )
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // admin or not
}
